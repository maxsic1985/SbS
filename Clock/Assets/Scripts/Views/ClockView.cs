...
public class ClockView : BaseView
{
    ...
    [SerializeField] private Toggle _checkBoxSetTimeFromClockHand;
    [SerializeField] private Toggle _checkBoxSetTimeFromTextInput;
    ...
    public Toggle CheckBoxSetTimeFromClockHand => _checkBoxSetTimeFromClockHand;
    public Toggle CheckBoxSetTimeFromTextInput => _checkBoxSetTimeFromTextInput;
